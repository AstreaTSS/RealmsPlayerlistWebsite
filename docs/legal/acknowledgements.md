...
- [orjson](https://github.com/ijl/orjson) by [ijl](https://github.com/ijl) is... just a fun thing to use. Fast, always correct, and pretty much unrivaled[^2] - what more could you want?
...
[^2]: [msgspec](https://jcristharif.com/msgspec/) may be faster, but its design decisions don't work as well for this bot.